...
#Region "Color Attributes"
    ...
    ''' <returns>a string for the attributes value</returns>
    ''' <remarks>call the string methed of get for the attribute work</remarks>
    <DebuggerStepThrough()> Public Shared Function [Get](ByVal Node As XmlNode, ByVal Name As String, ByVal DefaultValue As WireColor) As WireColor
        Dim c As WireColor
        Dim sc As String = [Get](Node, Name, DefaultValue.ToString)

        Try
            c = WireColor.FromName(sc)
        Catch ex As Exception
            c = DefaultValue
        End Try
    ...
    ''' <param name="Value">the value of the attribute to be saved</param>
    ''' <remarks>call the string of [set]</remarks>
    <DebuggerStepThrough()> Public Shared Sub [Set](ByVal Node As XmlNode, ByVal Name As String, ByVal Value As WireColor)
        [Set](Node, Name, Value.ToString)
    End Sub
