...
Partial Class B_CompareAnalog_Props
    ...
    Private Sub InitializeComponent()
        ...
        Me.cmbcompare.Items.AddRange(New Object() {"( > ) o_0 gets the greater value of i_0 and i_1", "( < ) o_0 gets the smaller value of i_0 and i_1"})
